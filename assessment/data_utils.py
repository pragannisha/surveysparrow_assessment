...
def eda(dataset):
    ...
    if X_df.shape[1] <= 10:  # Pairplot is useful for a small number of features
        plt.figure(figsize=(12, 8))
        sns.pairplot(X_df)
    ...
    if X_df.shape[1] <= 10:  # Scatter plots are useful for a small number of features
        plt.figure(figsize=(12, 8))
